    ...
    html += `<div class="history-item" style="border-bottom:1px solid rgba(255,255,255,0.06);padding:12px 0;">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;">
        <div style="flex:1;min-width:0;">
          <div style="font-weight:600;color:#f1f5f9;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${escapeHtml(h.task || '未命名任�?)}</div>
          <div style="font-size:12px;color:#94a3b8;margin-top:2px;">${dateStr} · ${h.totalSteps || 0}�?· ${timeStr} · ${h.completedSteps || 0}项产�?/div>
        </div>
